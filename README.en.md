...
![Overlay running over the game](docs/images/overlay-in-game.png)
...
- [Game Overlay User Guide](docs/OVERLAY_GUIDE.en.md)
...
![Minimap showing dungeon mechanics](docs/images/minimap-dungeon.png)
...
| **Buff Tracker** | Tracks configured buff/debuff data |
...
![DPS Statistics analysis page](docs/images/analysis-dps.png)
...
![Server region and launch configuration](docs/images/settings-launcher.png)
